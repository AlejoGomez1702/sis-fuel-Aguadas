...
public class Login extends javax.swing.JFrame 
{
    ...
    {
        initComponents();
        this.presentation = new AuthPresentation(this, this.txtUsuario, this.txtContrasena);
        this.logic = new AuthController(this.presentation);
    }
    
    /**
     * Comprueba si es posible o no ingresar al sistema.y de ser correctos 
     * los datos abre la ventana principal del sistema.
     * @return 
     */
    public boolean comprobarIngreso()
    {
        String name = this.txtUsuario.getText();
        String pass = this.txtContrasena.getText();      
        int initPermission = this.logic.verifyIncome(name, pass);
        //Indica si los datos son correctos o no.
        boolean session = this.presentation.checkInformation(initPermission);
        if(session)
        {
            //JOptionPane.showMessageDialog(this, "ENTRAAAA");
            this.dispose();
//JOptionPane.showMessageDialog(this, "pasa ===> 1");
            MainWindow mw = new MainWindow();
//JOptionPane.showMessageDialog(this, "pasa ===> 2");
            mw.setVisible(true);
        }
    ...
    private void initComponents() {
        ...
        labelMinimizar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/iconoMinimizar.png"))); // NOI18N
        ...
        labelCerrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/iconoCerrar.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icono_user_login_2.png"))); // NOI18N
    ...
    private void btnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEntrarActionPerformed
        boolean check = this.comprobarIngreso();
        if(!check)
            JOptionPane.showMessageDialog(this, "ERROR, Compruebe los datos ingresados");
        //JOptionPane.showMessageDialog(this, "El chequeo dio: " + check);
    ...
    private void txtContrasenaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtContrasenaKeyPressed
        ...
        //System.out.println("Evento: " + evt.getKeyCode());
